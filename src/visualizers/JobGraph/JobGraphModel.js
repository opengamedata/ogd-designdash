...
export class JobGraphModel extends VisualizerModel {
   ...
   */
   initializeFromRawData(raw_data, link_mode) {
      ...
      console.log(`After filtering in initializeFromRawData, there are ${relevantNodes.length}`)
   ...
   */
   static genNodeBuckets(rawData, meta) {
      ...
      console.log(`In genNodeBuckets, generated ${Object.keys(nodeBuckets).length} node 'buckets'.`)
