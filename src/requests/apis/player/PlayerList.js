...
export class PlayerListRequest extends APIRequest {
   ...
   genLocalStorageKey() {
      return ["PLAYER", this.game_name, this.min_app_version, this.max_app_version, this.min_log_version, this.max_log_version, ISODatetimeFormat(this.start_date ?? new Date()), ISODatetimeFormat(this.end_date ?? new Date())].join("/")
   }
}
